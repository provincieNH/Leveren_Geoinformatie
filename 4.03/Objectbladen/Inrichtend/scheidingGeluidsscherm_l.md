...
|TYPESPEC                            |String(255,0,0)    |Nadere typering van het object, keuzelijst [typeSpecSHDGeluidscherm] - Nullable: True Default: None|
...
|OBJECTEINDTIJD                      |Date(8,0,0)        |Datum waarop het objeconet bij de bronhouder niet meer geldig is - Nullable: True|
...
|NAAM                                |String(255,0,0)       |Naam van het Element. Let op hier is een naamgevings systematiek op van toepassing  - Nullable: True Default: None|
|KRITISCH                            |String(1,0,0)         |Kritisch (Ja / Nee) - Nullable: True Default: None|
|CONFORMNEN                          |String(1,0,0)         |Is Element conform NEN ja of nee - Nullable: True Default: None|
...
|OPPERVLAKTE                         |Float(0,25,10)        |Oppervlakte van de constructie. m2, 2 decimalen - Nullable: True|
|GELUID_VOORZ                        |String(255,0,0)       |FK naar geluidwerendeVoorziening_l - Nullable: True Default: None|
