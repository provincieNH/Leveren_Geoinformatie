...
|AANWEZGIHEIDDIM                     |TEXT(1,0,0)            |PNH; Aanwezigheid van een diminstallatie in de kast: Ja/Nee; keuzelijst [jaNee]; Nullable: True; Default: N; Visible: No|
|AANWTELEMANAGEMENT                  |TEXT(1,0,0)            |PNH; Aanwezigheid van een telemanagementvoorziening in de kast (t.b.v. het op afstand kunnen instellen): Ja/Nee; keuzelijst [jaNee]; Nullable: True; Default: N; Visible: No|
|AUTOMAATKOPPELING                   |TEXT(20,0,0)           |PNH; Aangeven of er een koppeling is tussen automaat en Ovlkast; keuzelijst [jaNeeOnbekend]; Nullable: True; Default: None; Visible: Yes|
...
|TYPEDIMSYSTEEM                      |TEXT(20,0,0)           |PNH; Het type dimsysteem mits de kastOvl is aangesloten op een dimsysteem, zie AANWEZIGHEIDDIM; keuzelijst [jaNeeOnbekend]; Nullable: True; Default: None; Visible: No|
