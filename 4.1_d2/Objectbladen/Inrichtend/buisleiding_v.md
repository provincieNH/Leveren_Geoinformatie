...
2. buisleidingen voor het vervoer van brandbare vloeistoffen van de categorie�n K1, K2 of K3, met een uitwendige diameter van meer dan 100mm
...
|AANTALBUIZEN                        |SmallInteger(0,10,0)   |PNH; Aantal buizen gerepresenteerd door de SHAPE van dit object. Wordt alleen opgenomen indien het aantal groter is dan 1 en de buizen niet als afzonderlijke lijnen (kunnen) worden weergegeven; ; Nullable: False; Default: None; Visible: Yes|
