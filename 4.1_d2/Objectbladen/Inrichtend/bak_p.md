...
|KOLOM                               |TYPE         	         |DEFINITIE (oorsprong; beschrijving; keuzelijst; nullable; default; zichtbaar in Areaalviewer)|
|------                              |----             	     |-----    |
...
|STATUS                              |String(10,0,0)         |BGT; De status gekoppeld aan de levenscyclus van een geo-object; keuzelijst [status]; Nullable: False; Default: bestaand; Visible: No|
...
|ZIJDE                               |String(10,0,0)         |PNH; Zijde; keuzelijst [ZIJDE]; Nullable: True; Default: Nieuw; Visible: No|
