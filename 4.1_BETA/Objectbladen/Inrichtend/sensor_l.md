...
|TYPESPEC                            |String(255,0,0)         |PNH; Nadere typering van het object; keuzelijst [typeSpecSNSLijn]; Nullable: True; Default: None|
|BGTPLUSTYPE                         |String(50,0,0)          |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeSNSLijn]; Nullable: False; Default: None|
|AANTALWINDINGEN                     |SmallInteger(0,10,0)    |PNH; Aantal windingen; Nullable: True|
