...
|FYSIEKVOORKOMEN                   |String(50,0,0)            |BGT; Fysieke omschrijving van het object; keuzelijst [fysiekVoorkomenBTD]; Nullable: False; Default: groenvoorziening; Visible:No|
|OPTALUD                           |String(1,0,0)             |BGT; Ligt het object op een talud? Ja/Nee/Onbekend. Bij 'Ja', moet er een begroeidTerreindeelPlKr_l geregistreerd zijn; keuzelijst [OPTALUD]; Nullable: False; Default: None; Visible:No|
...
|HMBEGIN                           |Float(0,25,10)            |PNH; Hectometrering begin heg; Nullable: True; Visible:No|
...
|OEVERVAK                          |String(255,0,0)           |PNH; FK naar oevervak_v; als deze aan een vaarweg ligt; Nullable: True; Default: None; Visible:Yes|
