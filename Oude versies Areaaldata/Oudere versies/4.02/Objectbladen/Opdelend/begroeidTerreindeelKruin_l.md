...
|------                          	|----          	            |-----    |
|IDENTIFICATIE                      |String(255,0,0)            |Beschrijving - keuzelijst [] Nullable: True Default: None|
...
|BEGROEIDTERREINDEEL                 |String(255,0,0)    |FK naar begroeidterreindeel_v - Nullable: True Default: None|
