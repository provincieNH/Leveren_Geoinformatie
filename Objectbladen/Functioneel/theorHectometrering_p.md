...
|------                              |----              |-----    |
|HECTOMETER                          |String(255,0,0)   |Hectometer aanduiding - Nullable: True Default: None|
|WEG_OF_VAARWEGNUMMER                |String(255,0,0)   |Het nummer van de naastgelegen (vaar)weg of het OV-traject - Nullable: True Default: None|
