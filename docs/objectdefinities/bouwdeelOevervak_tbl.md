...
* __Geometrie:__ Geen
* __Definitie:__ Bouwdeelniveau van decompositie van oevervakken (oevervak_v).
...
|OEVERVELEMENT                       |TEXT(255,0,0)           |PNH; Verwijzende sleutel naar ElementOevervak_tbl (simpel); ; Nullable: True; Default: None; Visible: Yes|
