...
![Portaal](https://github.com/provincieNH/Leveren_Geoinformatie/raw/master/4.3_d4/Objectbladen\04_Ovl_Vri\portaal_uithouder.png)
* __Mapping_BGT:__ x
...
|TYPESPEC                            |String(255,0,0)          |PNH; Nadere typering van het object, 'Uitlegger' of 'Portaal'; keuzelijst [typeSpecUIP](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeSpecUIP.html); Nullable: True; Default: None; Visible: Yes|
