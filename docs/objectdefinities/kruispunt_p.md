...
|EIGENAAR                            |String(255,0,0)    |PNH; Eigenaar van het object; keuzelijst [INSTANTIE](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/INSTANTIE.html); Nullable: True; Default: None; Visible: No; Visible: No|
|TYPESPEC                            |String(255,0,0)    |PNH; Nadere typering van het object; keuzelijst [typeSpecKRU](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeSpecKRU.html); Nullable: True; Default: None; Visible: Yes; Visible: Yes|
