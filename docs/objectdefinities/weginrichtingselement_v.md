...
|BGTPLUSTYPE                         |String(50,0,0)            |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeWGIVlak](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeWGIVlak.md); Nullable: False; Default: None; Visible: No|
