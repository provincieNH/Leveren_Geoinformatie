...
|TYPESPEC                            |TEXT(255,0,0)           |PNH; PNH eigen nadere typering van het object; keuzelijst [TypeSpecUTN](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/TypeSpecUTN.html); Nullable: False; Default: None; Visible: No|
|VERWERKINGSSTATUS                   |TEXT(255,0,0)           |PNH; Status van de gegevens; keuzelijst [VERWERKINGSSTATUS](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/VERWERKINGSSTATUS.html); Nullable: False; Default: Nieuw; Visible: No|
