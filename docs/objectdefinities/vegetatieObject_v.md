...
|BGTPLUSTYPE                         |String(50,0,0)           |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeVGOVlak](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeVGOVlak.md); Nullable: False; Default: None; Visible: No|
