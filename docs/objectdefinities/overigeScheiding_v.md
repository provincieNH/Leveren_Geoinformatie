...
|BGTPLUSTYPE                        |String(50,0,0)          |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeOSHVlak](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeOSHVlak.md); Nullable: False; Default: None; Visible: No|
