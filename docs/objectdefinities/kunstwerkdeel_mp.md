...
|BGTPLUSTYPE                       |String(50,0,0)          |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeKWDPunt](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeKWDPunt.md); Nullable: False; Default: None; Visible: No|
