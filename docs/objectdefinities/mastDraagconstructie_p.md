...
|TYPESPEC                            |String(255,0,0)          |PNH; Nadere typering van het object; keuzelijst [typeSpecMSTDraagconstructie](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeSpecMSTDraagconstructie.md); Nullable: True; Default: None; Visible: Yes|
|BGTPLUSTYPE                         |String(50,0,0)           |PNH; Nadere type omschrijving in de BGT; keuzelijst [typeMST](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeMST.md); Nullable: False; Default: None; Visible: No|
