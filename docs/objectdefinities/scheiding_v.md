...
|TYPESPEC                           |String(255,0,0)           |PNH; Nadere typering van het object; keuzelijst [typeSpecSHDVlak](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeSpecSHDVlak.md); Nullable: True; Default: None; Visible: Yes|
|BGTPLUSTYPE                        |String(50,0,0)            |BGT; Nadere type omschrijving in de BGT; keuzelijst [typeSHDVlak](http://provincienh.github.io/Leveren_Geoinformatie/keuzelijsten/typeSHDVlak.md); Nullable: False; Default: None; Visible: No|
