...
|nen_materiaalsoort|nen materiaalsoort|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Materiaaltype](../domeinen/Materiaaltype.html)||Default: None|NENMateriaalsoort|
|onderdeel_van_element|onderdeel van element|TEXT(255,0)|PNH|Decompositie|Vrij invoerveld||Verwijzende sleutel naar [kwelement_tbl]|Default: None|Verwijzende sleutel naar kwelement_tbl|
...
|type_bouwdeel|type bouwdeel|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [typeKWbouwdeel](../domeinen/typeKWbouwdeel.html)||Default: None|NEN kunstwerk bouwdelen.|
