...
|beheerobject_subtype|beheerobject subtype|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [BEHEER_OBJECT_SUBTYPE](../domeinen/BEHEER_OBJECT_SUBTYPE.html)||Default: Onderdoorgang|Beheerobject subtype.|
...
|objectnummer|objectnummer|TEXT(255,0)|IMBOR|ReëelObject|Vrij invoerveld|||Default: None|Nummer van het beheerobject, door de organisatie zelf in te delen. Topcodebepaald PNH zelf|
