...
|beheergebied|beheergebied|TEXT(255,0)|IMBOR|Beheerd object|Enumeratie/Referentie|keuzelijst [GCR_NAAM](../domeinen/GCR_NAAM.html)|Verwijzende sleutel naar [gebiedscontractregio_v]|Default: None|Verwijzende sleutel naar gebiedscontractregio_v|
|belastingklasse_rooster|belastingklasse|TEXT(255,0)|IMBOR|Rooster|Enumeratie/Referentie|keuzelijst [RoosterBelastingklasse](../domeinen/RoosterBelastingklasse.html)||Default: None|Belastingklassen volgens DIN19580/EN1433.|
...
|geldende_beeldkwaliteit|geldende beeldkwaliteit|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Beeldkwaliteit](../domeinen/Beeldkwaliteit.html)||Default: None|Streefbeeld|
...
|kilometrering_begin|kilometrering begin|FLOAT(6,2)|PNH|Areaaldata|Vrij invoerveld|||Default: None|hectometrering begin berm|
|kilometrering_eind|kilometrering eind|FLOAT(6,2)|PNH|Areaaldata|Vrij invoerveld|||Default: None|hectorering eind berm|
|lengte|lengte (cm)|FLOAT(6,2)|IMBOR|Weginrichtingsobject|Vrij invoerveld|||Default: None|Lengte van het beheerobject.|
...
|materiaaltype|materiaaltype|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Materiaaltype](../domeinen/Materiaaltype.html)||Default: None|Type materiaal|
...
|oppervlakte|oppervlakte (m2)|DOUBLE(10,3)|IMBOR|Weginrichtingsobject|Vrij invoerveld|||Default: None|Oppervlakte van het beheerobject, overname van BGT/IMGeo.|
|plaatsorientatie|plaatsorientatie|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Plaatsorientatie](../domeinen/Plaatsorientatie.html)||Default: None|Positie van het wegobject binnen het wegvak tov verloop van de hectometrering|
...
|type|rooster bgtplustype|TEXT(255,0)|IMBOR|Rooster|Enumeratie/Referentie|keuzelijst [RoosterType](../domeinen/RoosterType.html)||Default: None|Typering van het beheerobject.|
|type_conservering|type conservering|TEXT(255,0)|IMBOR|Constructie|Enumeratie/Referentie|keuzelijst [ConstructieTypeConservering](../domeinen/ConstructieTypeConservering.html)||Default: None|Aanduiding voor de wijze waarop het object geconserveerd is.|
|type_detail|rooster type detail|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [RoosterType](../domeinen/RoosterType.html)||Default: None|Typering van het beheerobject.|
