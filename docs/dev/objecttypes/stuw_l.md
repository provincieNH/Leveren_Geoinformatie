...
|bgt_objecttype|bgt classificatie|TEXT(255,0)|IMBOR|Geo-object|Enumeratie/Referentie|keuzelijst [BGTclassificatie](../domeinen/BGTclassificatie.html)||Default: kunstwerkdeel_l|Specificatie van het BGT/IMGeo-object.|
...
|bgt_type|bgt plustype|TEXT(255,0)|IMBOR|Stuw|Enumeratie/Referentie|keuzelijst [BGTPlusType](../domeinen/BGTPlusType.html)||Default: stuw|Specificatie van het soort object.|
...
|breedte|breedte (m)|DOUBLE(10,3)|PNH|Areaaldata|Vrij invoerveld|||Default: None|Breedte (in meters, 2 decimalen), indien rechthoekige duiker.|
...
|drempel_beweegbaar|drempel beweegbaar|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [JaNee](../domeinen/JaNee.html)||Default: None|is de drempel beweegbaar/instelbaar.|
|drempel_hoogte|drempel hoogte (NAP)|FLOAT(6,2)|PNH|Areaaldata|Vrij invoerveld|||Default: None|de hoogte van de drempel.|
...
|gemeentenaam|gemeentenaam|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Gemeentenaam](../domeinen/Gemeentenaam.html)||Default: None|Naam van de gemeente waarbinnen het beheerobject ligt.|
...
|hoogte|hoogte (m)|DOUBLE(10,3)|PNH|Areaaldata|Vrij invoerveld|||Default: None|Hoogte (m, 2 decimalen), indien rechthoekige duiker.|
|hoogtebovennap|hoogteboven nap|DOUBLE(10,3)|PNH|Areaaldata|Vrij invoerveld|||Default: None|Hoogte (m, 2 decimalen), indien rechthoekige duiker.|
...
|lengte|lengte (m)|FLOAT(6,2)|PNH|Areaaldata|Vrij invoerveld|||Default: None|Lengte van het beheerobject in meters.|
|loopdek|loopdek|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [JaNeeOnbekend](../domeinen/JaNeeOnbekend.html)||Default: None|Loopdek aanwezig|
...
|type|stuw type|TEXT(255,0)|IMBOR|Kunstwerk|Enumeratie/Referentie|keuzelijst [StuwType](../domeinen/StuwType.html)||Default: None|Typering van het beheerobject.|
