...
|bijzonder_transport|bijzonder transport|TEXT(255,0)|IMBOR|Flyover|Enumeratie/Referentie|keuzelijst [JaNee](../domeinen/JaNee.html)||Default: None|Aanduiding of bijzonder transport wel of niet over of naast een object mag rijden.|
...
|conformnen|conformnen|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [JaNeeOnbekend](../domeinen/JaNeeOnbekend.html)||Default: None|Indicatie of classificatie conform NEN is: Ja/Nee/Onbekend.|
...
|hoofdroute_onderdoor|hoofdroute onderdoor|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [Hoofdroute](../domeinen/Hoofdroute.html)||Default: None|indien nodig een tweede traject benoemen -die dat onderdoor loopt|
