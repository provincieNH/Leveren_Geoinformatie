...
|aantal_deklagen|aantal deklagen|SHORT(5,0)|IMBOR|Areaaldata|Vrij invoerveld|||Default: None|Aantal lagen|
|aantal_onderlagen|aantal onderlagen|SHORT(5,0)|IMBOR|Areaaldata|Vrij invoerveld|||Default: None|Aantal lagen|
|aantal_tussenlagen|aantal tussenlagen|SHORT(5,0)|IMBOR|Areaaldata|Vrij invoerveld|||Default: None|Aantal lagen|
...
|bgt_objecttype|bgt classificatie|TEXT(255,0)|IMBOR|Areaaldata|Enumeratie/Referentie|keuzelijst [BGTclassificatie](../domeinen/BGTclassificatie.html)||Default: wegdeel_v|De verschillende classificatie uit de BGT|
