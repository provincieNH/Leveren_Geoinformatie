...
|beheergebied|beheergebied|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [GCR_NAAM](../domeinen/GCR_NAAM.html)|Verwijzende sleutel naar [gebiedscontractregio_v]|Default: None|Verwijzende sleutel naar gebiedscontractregio_v|
...
|grondsoortnaam|grondsoortnaam|TEXT(255,0)|PNH|Areaaldata|Enumeratie/Referentie|keuzelijst [GrondsoortType](../domeinen/GrondsoortType.html)||Default: None|type grond onder de wegvak|
...
|verkeersintensiteit|verkeersintensiteit|FLOAT(6,2)|IMBOR|Wegvak|Vrij invoerveld|||Default: None|pae|
|wegnummer|wegnummer|TEXT(255,0)|IMBOR|Wegvak|Enumeratie/Referentie|keuzelijst [Wegnummer](../domeinen/Wegnummer.html)||Default: None|traject|
