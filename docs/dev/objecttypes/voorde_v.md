...
* __Geometrie:__ Vlak
* __Definitie:__ Een doorwaadbare, doorgaans verharde, plaats in de waterloop, die dient voor de oversteek van die waterloop.
...
|hoofdroute|hoofdroute|TEXT(255,0)|PNH|Voorde|Enumeratie/Referentie|keuzelijst [Hoofdroute](../domeinen/Hoofdroute.html)|Verwijzende sleutel naar [weg_v]|Default: None|Verwijzende sleutel naar weg_v (simpel)|
...
|plus_type|bgt plustype|TEXT(255,0)|IMBOR|Voorde|Enumeratie/Referentie|keuzelijst [typeKWDVlak](../domeinen/typeKWDVlak.html)||Default: niet-bgt:voorde|IMGeo plus populatie.|
