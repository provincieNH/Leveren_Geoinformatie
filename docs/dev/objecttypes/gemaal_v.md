...
|bgt_type|bgt plustype|TEXT(255,0)|IMBOR|Gemaal|Enumeratie/Referentie|keuzelijst [BGTPlusType](../domeinen/BGTPlusType.html)||Default: gemaal|Nadere type omschrijving in de BGT.|
