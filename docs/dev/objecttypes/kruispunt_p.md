...
|beheergebied|beheergebied|TEXT(255,0)|PNH|Beheerd object|Enumeratie/Referentie|keuzelijst [GCR_NAAM](../domeinen/GCR_NAAM.html)|Verwijzende sleutel naar [gebiedscontractregio_v]|Default: None|Verwijzende sleutel naar gebiedscontractregio_v. De provincie heeft haar gebied in 8 gebieden opgesplitst. Amsterdam (gebied 8) is zelfstandig. Er zijn geen beheerobjecten in Areaaldata.|
...
|kruispunttype|kruispunttype|TEXT(255,0)|IMBOR|Kruispunt|Enumeratie/Referentie|keuzelijst [KruispuntType](../domeinen/KruispuntType.html)||Default: None|Typering van het beheerobject.|
|kruispunttype_detail|kruispunttype_detail|TEXT(255,0)|IMBOR|Kruispunt|Enumeratie/Referentie|keuzelijst [KruispuntTypeGedetailleerd](../domeinen/KruispuntTypeGedetailleerd.html)||Default: None|Nadere typering van het type beheerobject.|
...
|wegnummer|wegnummer|TEXT(255,0)|IMBOR|Verharding|Enumeratie/Referentie|keuzelijst [Wegnummer](../domeinen/Wegnummer.html)||Default: None|N-nummer van hoofdroute|
