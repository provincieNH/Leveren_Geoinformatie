...
* __Geometrie:__ Vlak
* __Definitie:__ Dwars op het water opgeworpen waterbouwkundige constructie om water te keren, te beheersen, te leiden of te verdelen.
...
|bor_type|bor-type|TEXT(255,0)|IMBOR|Dam|Waarde wordt automatisch bepaald|||Default: dam|Aanvullend element van het IMBOR-schema in het geo-bor koppelvlak, voor het uitwisselen van types die niet in de huidige versie van IMGeo voorkomen.|
