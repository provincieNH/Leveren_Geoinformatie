## CommunicatiemoduleCommunicatieprotocol
...
| Ethernet | Ethernet | Een netwerkstandaard waarmee objecten binnen een LAN-verbinding met elkaar communiceren. |
| GPRS | GPRS | General Packet Radio Service is een techniek die een uitbreiding vormt op het bestaande gsm-netwerk. |
| Glasvezel | Glasvezel | Een vezel van glas die zo dun is als een haar en vanwege deze materie-eigenschap een uitstekende signaaldrager is. |
...
| Sigfox | Sigfox | Een draadloos netwerk dat weinig energieverbruik vraagt en het product is van de Franse netwerkleverancier Sigfox. |
