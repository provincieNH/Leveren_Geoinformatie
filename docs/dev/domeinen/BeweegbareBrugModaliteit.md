...
| Exceptioneel transport | Exceptioneel transport | Vervoer van goederen dat qua afmetingen (lengte, breedte, hoogte) en/of massa de regelgeving voor het wegvervoer niet naleeft. Indien zulk transport wil plaatsvinden, dient een vergunning of ontheffing aangevraagd te worden bij de overheid. |
...
| Tram | Tram | Een voertuig dat gebruikmaakt van rails die veelal binnen de openbare weg liggen, waardoor een tram deelneemt aan het openbare verkeer. |
| Trein | Trein | Een combinatie van voertuigen die wordt voortbewogen over een netwerk van rails: het spoorwegennet. |
