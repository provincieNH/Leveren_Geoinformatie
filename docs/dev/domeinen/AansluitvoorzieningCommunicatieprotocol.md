## AansluitvoorzieningCommunicatieprotocol
...
| GPRS | General Packet Radio Service | General Packet Radio Service is een techniek die een uitbreiding vormt op het bestaande gsm-netwerk. |
| IPv6LoPAN | Pv6 over Low-Power Wireless Personal Area Networks | Een afkorting van 'Pv6 over Low -Power Wireless Personal Area Networks', een netwerkverbinding voor connectiviteit met een lage dataversnelling in de lokale omgeving. |
...
| PSTN | Public Switched Telephone Network | Public Switched Telephone Network is de benaming van het wereldwijd gebruikte telefonienetwerk. |
